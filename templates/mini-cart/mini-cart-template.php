                    ...
                    <li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
                        ...
                        <div class="mini-cart-quantity-wrapper">
                            ...
                            echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                ...
                                '<span class="quantity">' . sprintf( '%s &times; %s', $product_price, $cart_item['quantity'] ) . '</span>',
                                $cart_item,
                                $cart_item_key
                            );
                            ?>
                            <strong class="single-subtotal-item">
                                ...
                                <span class="wpc-minicart-subtotal">
                                    <?php echo esc_html( $cart_item['quantity'] * $_product->get_price() ); ?>
                                </span>
                            </strong>
                        </div>
                    </li>
        ...
        <div class="wpc-subtotal-wrap">
                    ...
                    if ( empty( WC()->cart->get_coupons() ) ) :
                        if ( wc_coupons_enabled() ) :
                            ...
                            <?php endif; ?>
                                    ...
                                    <button type="submit" id="minicart-apply-button" class="wpc-cupon-btn button" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'wpcafe' ); ?>">
                                        <?php echo esc_html__( 'Apply', 'wpcafe' ); ?>
                                    </button>
            ...
            <?php else : ?>
                ...
                $message = sprintf(
                    ...
                    __( 'Your current amount is %1$s, You need to add at least %2$s to place order', 'wpcafe' ),
    ...
    <div class="wpc-empty-cart">
        <div class="cart-wrapper">
            <p class="woocommerce-mini-cart__empty-message">
                <?php esc_html_e( 'No products in the cart.', 'wpcafe' ); ?>
            </p>
            <a href="<?php echo esc_url( $cart_link ); ?>" class="wpc-btn wpc-empty-btn">
                <?php esc_html_e( 'Explore Food Items', 'wpcafe' ); ?>
            </a>
        </div>
    </div>
<?php endif; ?>
