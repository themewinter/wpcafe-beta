...
class Notice{
    ...
    public function  generate_html() {
        ...
        <div 
            ...
            expired_time="<?php echo wp_kses_post($this->expired_time);  ?>"
            dismissible="<?php echo wp_kses_post($this->dismissible);  ?>"
        >
            ...
            <div class="notice-right-container <?php echo (empty($this->logo) ? 'notice-container-full-width' : ''); ?>">
                ...
                <?php if(empty($this->html)): ?>
                    <?php echo (empty($this->title) ? '' : sprintf('<div class="notice-main-title notice-vert-space">%s</div>', wp_kses_post($this->title)));  ?>
